        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="fish-header">
                    ...
                    <div class="col-md-6">
                        <a href="/manager"><img src="/images/logo/arm.jpg" class="fish-logo" width="100px" height="100px" /></a>
                    ...
                    <div class="col-md-3 text-left">
                        <h5><strong><input type="text" value="مجوز بانک مرکزی: {{\App\Http\Controllers\FunctionsController::e2p("02/164467")}}" style="border:none;font-weight: bold; width:250px; text-align:left;"/></strong></h5>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach(\App\Http\Controllers\AppendCustomerController::showManagerCustomers() as $index=>$item)
                        ...
                        <tr>
                            ...
                            <td><a style="color:black" href="/salary/activity/c/{{$item->customer_id}}/month/{{$month_id}}">{{$item->name}}</a></td>
