        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="fish-header">
                    ...
                    <div class="col-md-6">
                        <a href="/public/single/print/m/{{$mid}}/c/{{$cid}}/d/{{$dayid}}/month/{{$month}}"><img src="/public/images/logo/arm.jpg" class="fish-logo" width="100px" height="100px" /></a>
                        ...
                        <h5><strong><input type="text" value="گزارش فعالیت روزانه {{$full_name}}" style="text-align:center; border:none;font-weight: bold; width:450px;"/></strong></h5>
                ...
                <div class="container col-striped">
                    ...
                    @foreach(\App\Http\Controllers\SalaryController::thisDay($dayid, $month) as $days )
                        ...
                        @if($item->count() == 0)
                            <!--- absence --->
                            <form action="{{route('salary.single.edit')}}" method="get">
                                @csrf
                        ...
                        @else
                            ...
                            @foreach($item as $index => $cus)
                                ...
                                <form action="{{route('salary.single.edit')}}" method="get">
                                    ...
                                    <div class="row {{$cus_class}} {{( $status == "حضور" && ($index+1 < $item->count()) && ($item[$index+1]->pause != 1 && $item[$index+1]->start != 0) || ($item->count()==1) )?'bg-forgot':null}}">
                                        <div class="col">
                                            {{\App\Http\Controllers\FunctionsController::e2p(explode("/",$days->fa_date)[0])}}
                                        </div>
                                        <div class="col">
