        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="fish-header">
                    ...
                    <div class="col-md-6">
                        <a href="/public/reward/table/month/total/{{$month_id}}"><img src="/public/images/logo/arm.jpg" class="fish-logo" width="100px" height="100px" /></a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                \App\Http\Controllers\FunctionsController::e2p(
                                    number_format(
                                        (int)(
                                        \App\Http\Controllers\AppendRewardsController::getReward($month_id, $item->customer_id)
                                        )
                                    ))." ریال "
                                }}
                            </td>
